...
const nameToQuestionaireEN = new Map([
	...
	[
		"replaceConnectSide",
		"Does the same problem occur whether the left or right side is connected?",
	],
	[
		"connectOnlyOneHand",
		"If only the left side (right side) is connected, does it work properly as a left side (right side) keyboard?",
	],
	...
	[
		"testMicrocomputerOnly",
		"Detach microcontroller board from PCB. Next, if you connect microcontroller board to PC by USB connect, will os recognize board as keyboard?",
	],
