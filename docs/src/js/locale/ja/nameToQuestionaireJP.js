...
const nameToQuestionaireJP = new Map([
	...
	[
		"connectOnlyOneHand",
		"左側（右側）だけ接続した場合、左側（右側）のキーボードとして適切に動作しますか",
	],
	["ledOffTextarea", "点灯しない LED がある"],
	[
		"trackballDeviceProblemTextarea",
		"トラックボールやロータリーエンコーダーの問題",
	],
	[
		"otherBuildProblemTextarea",
		"上記以外の問題（ランドが剥がれた etc）が起きている",
	],
	["keyboardName", "キーボード名"],
	...
	[
		...
		"マイコンボードだけを PC に接続したらキーボードとして認識されますか？",
	],
