...
//   const notActionOneHandTextarea = document.getElementById("notActionOneHandTextarea");
  ...
  if (e.target.id == "split") {
    if (e.target.checked) {
	    toggleDomDisabled(replaceConnectSideYes, false, DEBUG_MODE);
	    toggleDomDisabled(replaceConnectSideNo, false, DEBUG_MODE);
	    toggleDomDisabled(connectOneHandOK, false, DEBUG_MODE);
	    toggleDomDisabled(connectOneHandNG, false, DEBUG_MODE);
    } else {
	    toggleDomDisabled(replaceConnectSideYes, true, DEBUG_MODE);
	    toggleDomDisabled(replaceConnectSideNo, true, DEBUG_MODE);
	    toggleDomDisabled(connectOneHandOK, true, DEBUG_MODE);
	    toggleDomDisabled(connectOneHandNG, true, DEBUG_MODE);
